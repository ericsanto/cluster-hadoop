...
-javaagent:/opt/jmx/jmx_prometheus_javaagent-1.6.0.jar=9404:/opt/jmx/namenode.yml"

export HDFS_DATANODE_OPTS="$HDFS_DATANODE_OPTS \
-javaagent:/opt/jmx/jmx_prometheus_javaagent-1.6.0.jar=9406:/opt/jmx/datanode.yml"
